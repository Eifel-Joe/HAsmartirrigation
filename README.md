...
> top of it sit this fork's Eifel-Joe branding and one patch that is an open pull
> request upstream right now:
>
> - [#146](https://github.com/JustChr/HAsmartirrigation/pull/146) — the rain skip looked
>   at the day after the run, so a dry day could be skipped for tomorrow's rain while the
>   rainy day itself watered. It now adds up the forecast from the run's own start, in
>   24-hour steps, and asks Pirate Weather and Met Office for a series long enough to
>   cover that window.
>
