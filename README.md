...
> ([#71](https://github.com/JustChr/HAsmartirrigation/pull/71)), and a UI-translation fix
> ([#73](https://github.com/JustChr/HAsmartirrigation/pull/73)). This build therefore carries **only this
