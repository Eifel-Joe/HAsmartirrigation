...
>
> - [#53](https://github.com/JustChr/HAsmartirrigation/pull/53) — drop the unused `run_data`/`stop_data` zone fields (cleanup)
> - [#54](https://github.com/JustChr/HAsmartirrigation/pull/54) — mechanical water distributor (opt-in, experimental)
>
> The earlier fixes from this fork (through #52) have all been **merged** into JustChr. As soon as these
