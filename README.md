...
> ([#114](https://github.com/JustChr/HAsmartirrigation/pull/114)). This build therefore carries **only this
> fork's Eifel-Joe branding** on top of that base — no functional difference from JustChr.
