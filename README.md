...
> display fix** (the "Last irrigation" timestamp and the "Duration" now reset after a self-closing or
> distributor run, the same way they always did for metered runs), plus this fork's Eifel-Joe branding.
