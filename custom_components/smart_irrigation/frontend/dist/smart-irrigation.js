      ...
      <ha-card id="zone-${null!==(i=e.id)&&void 0!==i?i:"new"}">
        ...
        <div class="card-content zone-settings">
          ...
          <ha-settings-row>
            ...
            <select
              class="settings-input"
              .value="${ha(null!==(s=Object.keys(Pt).find(t=>Pt[t]===e.drainage_rate))&&void 0!==s?s:"custom")}"
              @change="${i=>{const s=i.target.value;"custom"!==s&&void 0!==Pt[s]&&this.handleEditZone(t,Object.assign(Object.assign({},e),{[$t]:Pt[s]}))}}"
            >
              <option
                value="custom"
          ...
          ${"service"===e.watering_mode?W`
                <ha-settings-row>
                  ...
                  >
                  <span slot="description"
                    >${Es("panels.zones.labels.run_service_help",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                ...
                <ha-settings-row>
                  ...
                  >
                  <span slot="description"
                    >${Es("panels.zones.labels.duration_field_help",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                ...
                <ha-settings-row>
                  ...
                  >
                  <span slot="description"
                    >${Es("panels.zones.labels.duration_unit_help",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                ...
                <ha-settings-row>
                  ...
                  >
                  <span slot="description"
                    >${Es("panels.zones.labels.stop_service_help",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
          ...
          ${"mqtt"===e.watering_mode?W`
                <ha-settings-row>
                  ...
                  >
                  <span slot="description"
                    >${Es("panels.zones.labels.mqtt_topic_help",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                ...
                <ha-settings-row>
                  ...
                  >
                  <span slot="description"
                    >${Es("panels.zones.labels.mqtt_open_field_help",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                ...
                <ha-settings-row>
                  ...
                  >
                  <span slot="description"
                    >${Es("panels.zones.labels.mqtt_open_value_help",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                ...
                <ha-settings-row>
                  ...
                  >
                  <span slot="description"
                    >${Es("panels.zones.labels.mqtt_stop_value_help",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
