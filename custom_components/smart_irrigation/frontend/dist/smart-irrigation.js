...
/**
    ...
    `:Z``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return Z``;const i=(this.config.zone_sequencing||Pt)===Rt;return Z`
      <ha-card
          ...
          ${i?Z`
                <div class="setting-row">
                  ...
                  <input
                    ...
                    @input="${e=>{const t=parseInt(e.target.value,10);isNaN(t)||this.handleConfigChange({[Bt]:t})}}"
                  />
    ...
    `}_renderAdvisories(){var e,t;if(!this.hass)return Z``;const i=this.hass.language,s=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=s===Pt,n=s===Lt||s===Rt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return Z`
