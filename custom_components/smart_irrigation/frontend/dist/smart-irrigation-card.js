!function (e) {
  ...
  const ve = `v${"2026.06.14"}`,
    _e = "smart_irrigation",
    ye = ["de", "en", "es", "fr", "it", "nl", "no", "sk"],
    we = "metric",
    Ee = "bucket",
    ke = e => e.callWS({
      type: _e + "/zones"
  ...
  class ze extends He {
    constructor(e) {
      if (super(e), this.et = Z, e.type !== $e) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
    }
    render(e) {
  ...
  var Le = {
    ...
    je = {
      ...
      panels: Ie,
      title: Me,
      weather_service_config: Re,
      irrigation_start_triggers: Oe,
      weather_skip: Ue,
      coordinate_config: De,
      days_between_irrigation: Ge,
      zone_sequencing: Fe,
      field_help: We,
      wizard: Ze
    },
  ...
  function Xe(e, t) {
    var i = t && t.cache ? t.cache : nt,
      r = t && t.serializer ? t.serializer : Qe;
    return (t && t.strategy ? t.strategy : Je)(e, {
      cache: i,
      serializer: r
    });
  }
  ...
  function Je(e, t) {
    return qe(e, this, 1 === e.length ? Ke : Ye, t.cache.create(), t.serializer);
  }
  var Qe = function () {
  ...
  var tt,
    ...
    ot = {
      variadic: function (e, t) {
        return qe(e, this, Ye, t.cache.create(), t.serializer);
      },
      monadic: function (e, t) {
        return qe(e, this, Ke, t.cache.create(), t.serializer);
      }
    };
  function at(e) {
  ...
  function mt(e) {
    return !(!e || "object" != typeof e || e.type !== rt.number);
  }
  function ft(e) {
    return !(!e || "object" != typeof e || e.type !== rt.dateTime);
  }
  !function (e) {
  ...
  var bt = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/,
    vt = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
  function _t(e) {
    var t = {};
  ...
  function xt(e) {
    var t = {};
    return "r" === e[e.length - 1] ? t.roundingPriority = "morePrecision" : "s" === e[e.length - 1] && (t.roundingPriority = "lessPrecision"), e.replace(Et, function (e, i, r) {
  ...
  function Tt(e) {
    ...
    if ("E" === e[0] && "E" === e[1] ? (t = {
      ...
      var i = e.slice(0, 2);
      if ("+!" === i ? (t.signDisplay = "always", e = e.slice(2)) : "+?" === i && (t.signDisplay = "exceptZero", e = e.slice(2)), !At.test(e)) throw new Error("Malformed concise eng/scientific notation");
    ...
    for (var t = {}, i = 0, n = e; i < n.length; i++) {
      ...
      switch (o.stem) {
        ...
        case "integer-width":
          ...
          o.options[0].replace(kt, function (e, i, r, n, o, a) {
      ...
      if (At.test(o.stem)) t.minimumIntegerDigits = o.stem.length;else if (wt.test(o.stem)) {
        if (o.options.length > 1) throw new RangeError("Fraction-precision stems only accept a single optional option");
        o.stem.replace(wt, function (e, i, r, n, o, a) {
      ...
      } else if (Et.test(o.stem)) t = r(r({}, t), xt(o.stem));else {
        var s = St(o.stem);
        s && (t = r(r({}, t), s));
        var l = Tt(o.stem);
        l && (t = r(r({}, t), l));
  ...
  function Lt(e) {
    ...
    var i,
      r = e.language;
    return "root" !== r && (i = e.maximize().region), (Ct[i || ""] || Ct[r || ""] || Ct["".concat(r, "-001")] || Ct["001"])[0];
  }
  var Bt = new RegExp("^".concat(bt.source, "*")),
    Pt = new RegExp("".concat(bt.source, "*$"));
  function Nt(e, t) {
    return {
      start: e,
      end: t
  ...
  var It = !!String.prototype.startsWith && "_a".startsWith("a", 1),
    Mt = !!String.fromCodePoint,
    Rt = !!Object.fromEntries,
    Ot = !!String.prototype.codePointAt,
    Ut = !!String.prototype.trimStart,
    Dt = !!String.prototype.trimEnd,
    Gt = !!Number.isSafeInteger ? Number.isSafeInteger : function (e) {
      return "number" == typeof e && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
    },
    Ft = !0;
  try {
    Ft = "a" === (null === (zt = qt("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) || void 0 === zt ? void 0 : zt[0]);
  } catch (M) {
    Ft = !1;
  }
  var Wt,
    Zt = It ? function (e, t, i) {
      return e.startsWith(t, i);
    } : function (e, t, i) {
      return e.slice(i, i + t.length) === t;
    },
    jt = Mt ? String.fromCodePoint : function () {
    ...
    Vt = Rt ? Object.fromEntries : function (e) {
  ...
  if (Ft) {
    var Jt = qt("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    Wt = function (e, t) {
      var i;
      return Jt.lastIndex = t, null !== (i = Jt.exec(e)[1]) && void 0 !== i ? i : "";
    };
  } else Wt = function (e, t) {
    for (var i = [];;) {
      var r = Xt(e, t);
      if (void 0 === r || ri(r) || ni(r)) break;
      i.push(r), t += r >= 65536 ? 2 : 1;
    }
    return jt.apply(void 0, i);
  };
  var Qt,
    ei = function () {
      function e(e, t) {
      ...
      return e.prototype.parse = function () {
        ...
        for (var r = []; !this.isEOF();) {
          ...
          if (123 === n) {
            ...
            if (35 !== n || "plural" !== t && "selectordinal" !== t) {
              ...
              if (60 === n && !this.ignoreTag && ti(this.peek() || 0)) {
        ...
        if (this.bumpIf(">")) {
          ...
          if (this.bumpIf("</")) {
            if (this.isEOF() || !ti(this.char())) return this.error(tt.INVALID_TAG, Nt(a, this.clonePosition()));
            var s = this.clonePosition();
            return r !== this.parseTagName() ? this.error(tt.UNMATCHED_CLOSING_TAG, Nt(s, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">") ? {
              val: {
                type: it.tag,
                value: r,
                children: o,
              ...
              err: null
            } : this.error(tt.INVALID_TAG, Nt(a, this.clonePosition())));
          }
        ...
        return this.isEOF() || 60 !== this.char() || !this.ignoreTag && (ti(e = this.peek() || 0) || 47 === e) ? null : (this.bump(), "<");
        var e;
        ...
        var i = this.char();
        return 60 === i || 123 === i || 35 === i && ("plural" === t || "selectordinal" === t) || 125 === i && e > 0 ? null : (this.bump(), jt(i));
      }, e.prototype.parseArgument = function (e, t) {
        var i = this.clonePosition();
        if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(tt.EXPECT_ARGUMENT_CLOSING_BRACE, Nt(i, this.clonePosition()));
        if (125 === this.char()) return this.bump(), this.error(tt.EMPTY_ARGUMENT, Nt(i, this.clonePosition()));
        var r = this.parseIdentifierIfPossible().value;
        if (!r) return this.error(tt.MALFORMED_ARGUMENT, Nt(i, this.clonePosition()));
        if (this.bumpSpace(), this.isEOF()) return this.error(tt.EXPECT_ARGUMENT_CLOSING_BRACE, Nt(i, this.clonePosition()));
        switch (this.char()) {
          case 125:
            return this.bump(), {
              val: {
          ...
          case 44:
            return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(tt.EXPECT_ARGUMENT_CLOSING_BRACE, Nt(i, this.clonePosition())) : this.parseArgumentOptions(e, t, r, i);
          default:
        ...
        return this.bumpTo(r), {
          value: i,
          location: Nt(e, this.clonePosition())
        };
        ...
        switch (s) {
          case "":
            return this.error(tt.EXPECT_ARGUMENT_TYPE, Nt(a, l));
          case "number":
          case "date":
          case "time":
            this.bumpSpace();
            ...
            if (this.bumpIf(",")) {
              ...
              if (0 === (g = Yt(v.val)).length) return this.error(tt.EXPECT_ARGUMENT_STYLE, Nt(this.clonePosition(), this.clonePosition()));
              c = {
                style: g,
                styleLocation: Nt(h, this.clonePosition())
              };
            }
            if ((_ = this.tryParseArgumentClose(n)).err) return _;
            var u = Nt(n, this.clonePosition());
            if (c && Zt(null == c ? void 0 : c.style, "::", 0)) {
              var d = Kt(c.style.slice(2));
              ...
              if (0 === d.length) return this.error(tt.EXPECT_DATE_TIME_SKELETON, u);
              var p = d;
              ...
              var g = {
                ...
                parsedOptions: this.shouldParseSkeletons ? _t(p) : {}
              };
              return {
                val: {
                  type: "date" === s ? it.date : it.time,
                  value: i,
                  location: u,
                  style: g
                },
            ...
            return {
              val: {
                type: "number" === s ? it.number : "date" === s ? it.date : it.time,
                value: i,
                location: u,
          ...
          case "select":
            ...
            if (this.bumpSpace(), !this.bumpIf(",")) return this.error(tt.EXPECT_SELECT_ARGUMENT_OPTIONS, Nt(m, r({}, m)));
            this.bumpSpace();
            var f = this.parseIdentifierIfPossible(),
              b = 0;
            if ("select" !== s && "offset" === f.value) {
              if (!this.bumpIf(":")) return this.error(tt.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, Nt(this.clonePosition(), this.clonePosition()));
              var v;
              if (this.bumpSpace(), (v = this.tryParseDecimalInteger(tt.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, tt.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE)).err) return v;
          ...
          default:
            return this.error(tt.INVALID_ARGUMENT_TYPE, Nt(a, l));
        }
      }, e.prototype.tryParseArgumentClose = function (e) {
        return this.isEOF() || 125 !== this.char() ? this.error(tt.EXPECT_ARGUMENT_CLOSING_BRACE, Nt(e, this.clonePosition())) : (this.bump(), {
          val: !0,
          err: null
        });
        ...
        for (var e = 0, t = this.clonePosition(); !this.isEOF();) {
          switch (this.char()) {
            case 39:
              this.bump();
              var i = this.clonePosition();
              if (!this.bumpUntil("'")) return this.error(tt.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, Nt(i, this.clonePosition()));
              this.bump();
              break;
            case 123:
              e += 1, this.bump();
        ...
        try {
          i = function (e) {
            ...
            for (var t = e.split(yt).filter(function (e) {
                return e.length > 0;
          ...
          return this.error(tt.INVALID_NUMBER_SKELETON, t);
        }
        return {
          val: {
            type: rt.number,
            tokens: i,
            location: t,
            parsedOptions: this.shouldParseSkeletons ? Ht(i) : {}
          },
          err: null
        };
        ...
        for (var n, o = !1, a = [], s = new Set(), l = r.value, c = r.location;;) {
          if (0 === l.length) {
            ...
            var u = this.tryParseDecimalInteger(tt.EXPECT_PLURAL_ARGUMENT_SELECTOR, tt.INVALID_PLURAL_ARGUMENT_SELECTOR);
            if (u.err) return u;
            c = Nt(h, this.clonePosition()), l = this.message.slice(h.offset, this.offset());
          }
          if (s.has(l)) return this.error("select" === t ? tt.DUPLICATE_SELECT_ARGUMENT_SELECTOR : tt.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, c);
          "other" === l && (o = !0), this.bumpSpace();
          var d = this.clonePosition();
          if (!this.bumpIf("{")) return this.error("select" === t ? tt.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : tt.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, Nt(this.clonePosition(), this.clonePosition()));
          ...
          a.push([l, {
            value: p.val,
            location: Nt(d, this.clonePosition())
          }]), s.add(l), this.bumpSpace(), l = (n = this.parseIdentifierIfPossible()).value, c = n.location;
        }
        return 0 === a.length ? this.error("select" === t ? tt.EXPECT_SELECT_ARGUMENT_SELECTOR : tt.EXPECT_PLURAL_ARGUMENT_SELECTOR, Nt(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !o ? this.error(tt.MISSING_OTHER_CLAUSE, Nt(this.clonePosition(), this.clonePosition())) : {
          val: a,
          err: null
        };
        ...
        if (Zt(this.message, e, this.offset())) {
  ...
  function oi(e) {
    e.forEach(function (e) {
      if (delete e.location, ut(e) || dt(e)) for (var t in e.options) delete e.options[t].location, oi(e.options[t].value);else lt(e) && mt(e.style) || (ct(e) || ht(e)) && ft(e.style) ? delete e.style.location : gt(e) && oi(e.children);
    });
  }
  function ai(e, t) {
    void 0 === t && (t = {}), t = r({
    ...
    var i = new ei(e, t).parse();
    if (i.err) {
      var n = SyntaxError(tt[i.err.kind]);
  ...
  var si,
    ...
    ci = function (e) {
      function t(t, i, r, n) {
        return e.call(this, 'Invalid values for "'.concat(t, '": "').concat(i, '". Options are "').concat(Object.keys(r).join('", "'), '"'), Qt.INVALID_VALUE, n) || this;
      }
      return i(t, e), t;
    }(li),
    hi = function (e) {
      function t(t, i, r) {
        return e.call(this, 'Value for "'.concat(t, '" must be of type ').concat(i), Qt.INVALID_VALUE, r) || this;
      }
      return i(t, e), t;
    }(li),
    ui = function (e) {
      function t(t, i) {
        return e.call(this, 'The intl string context variable "'.concat(t, '" was not provided to the string "').concat(i, '"'), Qt.MISSING_VALUE, i) || this;
      }
      return i(t, e), t;
    }(li);
  function di(e) {
  ...
  function pi(e, t, i, r, n, o, a) {
    if (1 === e.length && at(e[0])) return [{
      type: si.literal,
      value: e[0].value
    }];
    for (var s = [], l = 0, c = e; l < c.length; l++) {
      ...
      if (at(h)) s.push({
        type: si.literal,
        value: h.value
      });else if (pt(h)) "number" == typeof o && s.push({
        type: si.literal,
        value: i.getNumberFormat(t).format(o)
      });else {
        var u = h.value;
        if (!n || !(u in n)) throw new ui(u, a);
        var d = n[u];
        if (st(h)) d && "string" != typeof d && "number" != typeof d || (d = "string" == typeof d || "number" == typeof d ? String(d) : ""), s.push({
          type: "string" == typeof d ? si.literal : si.object,
          value: d
        });else if (ct(h)) {
          var p = "string" == typeof h.style ? r.date[h.style] : ft(h.style) ? h.style.parsedOptions : void 0;
          s.push({
            type: si.literal,
            value: i.getDateTimeFormat(t, p).format(d)
          });
        } else if (ht(h)) {
          p = "string" == typeof h.style ? r.time[h.style] : ft(h.style) ? h.style.parsedOptions : r.time.medium;
          s.push({
            type: si.literal,
            value: i.getDateTimeFormat(t, p).format(d)
          });
        } else if (lt(h)) {
          (p = "string" == typeof h.style ? r.number[h.style] : mt(h.style) ? h.style.parsedOptions : void 0) && p.scale && (d *= p.scale || 1), s.push({
            type: si.literal,
          ...
          if (gt(h)) {
            var g = h.children,
              m = h.value,
              f = n[m];
            if (!di(f)) throw new hi(m, "function", a);
            var b = f(pi(g, t, i, r, n, o).map(function (e) {
              return e.value;
            }));
            Array.isArray(b) || (b = [b]), s.push.apply(s, b.map(function (e) {
              return {
                type: "string" == typeof e ? si.literal : si.object,
                value: e
              };
            }));
          }
          if (ut(h)) {
            if (!(v = h.options[d] || h.options.other)) throw new ci(h.value, d, Object.keys(h.options), a);
            s.push.apply(s, pi(v.value, t, i, r, n));
          } else if (dt(h)) {
            var v;
            if (!(v = h.options["=".concat(d)])) {
              if (!Intl.PluralRules) throw new li('Intl.PluralRules is not available in this environment.\nTry polyfilling it using "@formatjs/intl-pluralrules"\n', Qt.MISSING_INTL_API, a);
              var _ = i.getPluralRules(t, {
                type: h.pluralType
              }).select(d - (h.offset || 0));
              v = h.options[_] || h.options.other;
            }
            if (!v) throw new ci(h.value, d, Object.keys(h.options), a);
            s.push.apply(s, pi(v.value, t, i, r, n, d - (h.offset || 0)));
          } else ;
        }
      }
    }
    return function (e) {
      return e.length < 2 ? e : e.reduce(function (e, t) {
        var i = e[e.length - 1];
        return i && i.type === si.literal && t.type === si.literal ? i.value += t.value : e.push(t), e;
      }, []);
    }(s);
  }
  function gi(e, t) {
      ...
      function e(t, i, n, a) {
        ...
        if (this.formatterCache = {
          ...
          var i = t.reduce(function (e, t) {
            return e.length && t.type === si.literal && "string" == typeof e[e.length - 1] ? e[e.length - 1] += t.value : e.push(t.value), e;
          }, []);
          return i.length <= 1 ? i[0] || "" : i;
        }, this.formatToParts = function (e) {
          return pi(l.ast, l.locales, l.formatters, l.formats, e, void 0, l.message);
        ...
        this.formats = gi(e.formats, n), this.formatters = a && a.formatters || (void 0 === (s = this.formatterCache) && (s = {
          number: {},
          dateTime: {},
          pluralRules: {}
        }), {
  ...
  function wi(e) {
    const t = yi(e);
    return t in vi || !ye.includes(t);
  }
  function Ei(e, t, ...i) {
    const r = yi(t);
    let n;
    try {
      n = e.split(".").reduce((e, t) => e[t], vi[r]);
    } catch (t) {
      n = e.split(".").reduce((e, t) => e[t], vi.en);
    }
    if (void 0 === n && (n = e.split(".").reduce((e, t) => e[t], vi.en)), !i.length) return n;
    const o = {};
  ...
  function ki(e, t) {
    switch (t) {
      case "drainage_rate":
        return e.units == we ? F`${Ce("mm/h")}` : F`${Ce("in/h")}`;
      case "precipitation_threshold_mm":
      case Ee:
        return e.units == we ? F`${Ce("mm")}` : F`${Ce("in")}`;
      case "size":
        return e.units == we ? F`${Ce("m<sup>2</sup>")}` : F`${Ce("sq ft")}`;
      case "throughput":
        return e.units == we ? F`${Ce("l/minute")}` : F`${Ce("gal/minute")}`;
      default:
        return F``;
    }
  }
  ...
  function Ti(e, t, i, r) {
    var n;
    Si(e, `${Ei(i, null !== (n = null == t ? void 0 : t.language) && void 0 !== n ? n : "en")}: ${xi(r)}`);
  }
  const $i = (e, ...t) => {
      let i = {
        page: e,
...
`;
  const zi = e => String(e).padStart(2, "0");
  function Ci(e) {
    return e instanceof Date ? e : new Date(e);
  }
  function Li(e) {
    const t = Ci(e);
    return `${zi(t.getHours())}:${zi(t.getMinutes())}`;
  }
  function Bi(e, t) {
    return e.getFullYear() === t.getFullYear() && e.getMonth() === t.getMonth() && e.getDate() === t.getDate();
  }
  class Pi extends xe(ce) {
    constructor() {
    ...
    handleCalculateAllZones() {
      var e;
      this.hass && (this.isSaving = !0, this._scheduleUpdate(), (e = this.hass, e.callApi("POST", _e + "/zones", {
        calculate_all: !0
      })).catch(e => {
        console.error("Failed to calculate all zones:", e), Ti(this, this.hass, "common.errors.action_failed", e);
      }).finally(() => {
    ...
    handleUpdateAllZones() {
      ...
      this.hass && (this.isSaving = !0, this._scheduleUpdate(), (e = this.hass, e.callApi("POST", _e + "/zones", {
        ...
        console.error("Failed to update all zones:", e), Ti(this, this.hass, "common.errors.action_failed", e);
      }).finally(() => {
    ...
    async _doIrrigate() {
      ...
      try {
        await (o = this.hass, a = i ? void 0 : t, o.callWS(Object.assign({
          type: _e + "/irrigate_now"
        }, void 0 !== a ? {
          zone_id: a
        } : {}))), Si(this, `${Ei("panels.zones.confirm_irrigate.toast_started", this.hass.language)} ${n}`);
      } catch (e) {
        const t = xi(e);
        console.error("irrigate_now failed", e), Si(this, `${Ei("panels.zones.confirm_irrigate.toast_failed", this.hass.language)}: ${t}`);
      }
      var o, a;
    }
    handleCalculateZone(e) {
      ...
      var i, r;
      t && null != t.id && this.hass && (this._operationError = null, this.isSaving = !0, this._scheduleUpdate(), (i = this.hass, r = t.id.toString(), i.callApi("POST", _e + "/zones", {
        id: r,
        calculate: !0,
        override_cache: !0
      })).catch(e => {
    ...
    _openZoneSettings(e) {
      ...
      Ai(0, t ? $i("setup", "zones", t) : $i("setup", "zones"));
    }
    _runTargetsZone(e, t) {
    ...
    _formatRunTime(e) {
      ...
      const t = this.hass.language,
        ...
        r = Li(i),
        n = new Date();
      return Bi(i, n) ? `${Ei("panels.zones.outlook.today", t)} ${r}` : Bi(i, function (e, t) {
        const i = new Date(e.getTime());
        return i.setDate(i.getDate() + t), i;
      }(n, 1)) ? `${Ei("panels.zones.outlook.tomorrow", t)} ${r}` : function (e, t) {
        const i = Ci(e);
    ...
    _guardLabel(e) {
      return Ei(`panels.zones.outlook.checks.${e.id}`, this.hass.language);
    }
    _guardDetail(e) {
      var t;
      return e.available && null !== e.observed ? Ei(`panels.zones.outlook.check_detail.${e.id}`, this.hass.language, "{observed}", String(e.observed), "{threshold}", String(null !== (t = e.threshold) && void 0 !== t ? t : "")) : "";
    }
    _renderSkipReasons() {
      ...
      <div class="outlook-line outlook-dim skip-reasons-note">
        ${Ei("panels.zones.outlook.provisional", e)}
      </div>
    `;
    }
    _openSchedules() {
      Ai(0, $i("setup", "schedules"));
    }
    _runActionLabel(e) {
      return Ei(`panels.zones.outlook.actions.${e.action}`, this.hass.language);
    }
    _runTargetsLabel(e) {
      const t = this.hass.language;
      if ("all" === e.zones) return Ei("panels.zones.outlook.targets_all", t);
      const i = Array.isArray(e.zones) ? e.zones.length : 0;
      return Ei("panels.zones.outlook.targets_zones", t, "{count}", String(i));
    }
      ...
      <ha-card class="outlook-card">
        <div class="outlook">
          <div class="outlook-line outlook-headline">
            ...
            <span>
              <strong
                >${Ei("panels.zones.outlook.next_run", e)}:</strong
              >
          ...
          ${i.length > 0 ? F`
                <div class="outlook-line outlook-skip">
                  ...
                  <span
                    >${Ei("panels.zones.outlook.will_skip", e)}</span
                  >
                  <button
                    class="outlook-info-btn"
                    aria-expanded="${this._skipDetailsOpen}"
                    title="${Ei("panels.zones.outlook.why_skipped", e)}"
                    @click="${() => {
        this._skipDetailsOpen = !this._skipDetailsOpen;
                  ...
                  >
                    ...
                    <span class="outlook-info-label"
                      >${Ei("panels.zones.outlook.why_skipped", e)}</span
                    >
                  </button>
                </div>
              ...
              ` : F`
                <div class="outlook-line outlook-clear">
                  ...
                  <span
                    >${Ei("panels.zones.outlook.will_run", e)}</span
                  >
                </div>
              `}
        ...
        <ha-card class="outlook-card">
          <div class="outlook">
            <div class="outlook-line outlook-headline">
              ...
              <span>${Ei("panels.zones.outlook.no_schedule", e)}</span>
              ${this.hideSettingsLinks ? "" : F`
                    <button
                      class="outlook-link"
                      @click="${this._openSchedules}"
                    >
                      ${Ei("panels.zones.outlook.setup_schedule", e)}
                    </button>
                  `}
            </div>
            ${r ? this._renderLastRunLine(r) : ""}
    ...
    _renderLastRunLine(e) {
      const t = this.hass.language,
        ...
        n = e.would_skip ? `${Ei("panels.zones.outlook.last_run_skipped", t)}${r ? ` (${r})` : ""}` : Ei("panels.zones.outlook.last_run_ran", t);
      return F`
      <div class="outlook-line outlook-last">
        <span class="outlook-dim"
          >${Ei("panels.zones.outlook.last_run", t)}:</span
        >
        <span>${n} · ${i}</span>
      </div>
    `;
    ...
    _renderZoneDecision(e) {
      ...
      let n, o, a;
      if (e.state === Te.Disabled) n = Ei("panels.zones.status.decision_disabled", i), o = "neutral", a = "mdi:power-off";else if (e.last_calculated) {
        if (this._zoneHasDeficit(e)) {
          ...
          s.length > 0 ? (n = Ei("panels.zones.status.decision_water_skip", i, "{duration}", t, "{reason}", this._guardLabel(s[0]).toLowerCase()), o = "skip", a = "mdi:weather-rainy") : l && l.next_run_utc ? (n = Ei("panels.zones.status.decision_water_at", i, "{duration}", t, "{time}", this._formatRunTime(l.next_run_utc)), o = "water", a = "mdi:water") : (n = Ei("panels.zones.status.decision_water_no_schedule", i, "{duration}", t), o = "water", a = "mdi:water-alert");
        } else n = Ei("panels.zones.status.decision_no_water", i), o = "ok", a = "mdi:check-circle-outline";
      } else n = Ei("panels.zones.status.decision_unknown", i), o = "unknown", a = "mdi:help-circle-outline";
      return F`
    ...
    _renderZoneEstimate(e) {
      ...
      const i = this.hass.language,
        ...
        o = Ei(`panels.zones.status.estimate_method.${"proxy" === t.method ? "proxy" : "hourly"}`, i) + (t.as_of ? ` · ${Li(t.as_of)}` : "");
      return F`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${o}">
        ${Ei("panels.zones.status.estimate_now", i)}
        <strong style="color: ${n}"
          >≈ ${t.live_deficit.toFixed(2)} ${r}</strong
        >
        <span class="estimate-tag"
          >${Ei("panels.zones.status.estimate_tag", i)}</span
        >
      </span>
    `;
    }
    _renderZoneNextRun(e) {
      ...
      return e.state !== Te.Disabled && e.last_calculated && this._zoneHasDeficit(e) && 0 === this._triggeredGuards.length ? F`` : F`
      <span class="status-sep">·</span>
      <span>
        ${Ei("panels.zones.outlook.next_run", this.hass.language)}:
    ...
    renderZone(e, t) {
      ...
      const n = Number(null !== (i = e.bucket) && void 0 !== i ? i : 0),
        ...
        a = e.state === Te.Automatic ? "state-automatic" : e.state === Te.Manual ? "state-manual" : "state-disabled",
        s = e.last_calculated ? function (e) {
          const t = Ci(e);
          return `${t.getFullYear()}-${zi(t.getMonth() + 1)}-${zi(t.getDate())} ${zi(t.getHours())}:${zi(t.getMinutes())}`;
        }(e.last_calculated) : Ei("panels.zones.status.never", this.hass.language);
      return F`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
          <span class="zone-state-badge ${a}">
            ${Ei(`panels.zones.labels.states.${e.state}`, this.hass.language)}
          </span>
          ${this.hideSettingsLinks ? "" : F`
                <ha-icon-button
                  ...
                  title="${Ei("panels.zones.actions.open_settings", this.hass.language)}"
        ...
        <div class="card-content">
          <div class="zone-status-line">
            <span
              title="${Ei("panels.zones.help.bucket", this.hass.language)}"
            >
              ${Ei("panels.zones.labels.bucket", this.hass.language)}:
              <strong style="color: ${o}"
                >${n.toFixed(2)}
                ${ki(this.config, Ee)}</strong
              >
            </span>
            <span class="status-sep">·</span>
            <span>
              ${Ei("panels.zones.status.last_checked", this.hass.language)}:
              <strong>${s}</strong>
            </span>
        ...
        <div class="card-content zone-action-bar">
          ${"full" === this.actionsMode && e.state === Te.Automatic ? F`
                <button
                  class="action-btn"
                  title="${Ei("panels.zones.help.update", this.hass.language)}"
                  @click="${() => this.handleUpdateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Ei("panels.zones.actions.update", this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Ei("panels.zones.help.calculate", this.hass.language)}"
                  @click="${() => this.handleCalculateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Ei("panels.zones.actions.calculate", this.hass.language)}
                </button>
              ` : ""}
        ...
        void 0 !== e.id && (this._confirmIrrigate = e.id.toString());
                ...
                >
                  ...
                  ${Ei("panels.zones.labels.irrigate_now", this.hass.language)}
                </button>
              ` : e.linked_entity ? "" : F`
                  <button
                    class="action-btn"
                    disabled
                    title="${Ei("panels.zones.help.irrigate_link_entity", this.hass.language)}"
                  >
                    <ha-icon icon="mdi:water"></ha-icon>
                    ${Ei("panels.zones.labels.irrigate_now", this.hass.language)}
                  </button>
                  <span class="zones-top-note">
                    ${Ei("panels.zones.help.irrigate_link_entity", this.hass.language)}
                  </span>
                `}
        </div>
      </ha-card>
    ...
    render() {
      ...
      if (this.isLoading) return F`
        <ha-card header="${Ei("panels.zones.title", this.hass.language)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Ei("common.loading-messages.general", this.hass.language)}
            </div>
          </div>
        </ha-card>
      `;
      ...
      ${r ? this.hideSettingsLinks ? F`
              <ha-card>
                <div class="card-content description-text">
                  ${Ei("panels.zones.no_items", this.hass.language)}
                </div>
              </ha-card>
            ` : F`
                ...
                <div class="setup-banner">
                  ...
                  <div class="setup-banner-content">
                    <div class="setup-banner-title">
                      ${Ei("wizard.title", this.hass.language)}
                    </div>
                    <div class="setup-banner-desc">
                      ${Ei("wizard.setup_complete_banner", this.hass.language)}
                    </div>
                  </div>
                  <button
        ...
        this.dispatchEvent(new CustomEvent("open-wizard", {
          ...
          composed: !0
                  ...
                  >
                    ${Ei("wizard.open_wizard", this.hass.language)}
                  </button>
                </div>
              </ha-card>
            ` : ""}
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Ei("panels.zones.title", this.hass.language)}
          </div>
        </div>
        <div class="card-content zones-top-actions">
          ${"full" === this.actionsMode ? F`
                <button
                  class="action-btn"
                  title="${Ei("panels.zones.help.update_all", this.hass.language)}"
                  @click="${this.handleUpdateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Ei("panels.zones.cards.zone-actions.actions.update-all", this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Ei("panels.zones.help.calculate_all", this.hass.language)}"
                  @click="${this.handleCalculateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Ei("panels.zones.cards.zone-actions.actions.calculate-all", this.hass.language)}
                </button>
              ` : ""}
          ${"none" !== this.actionsMode ? F`
                <button
                  class="action-btn"
                  raised
                  title="${Ei("panels.zones.help.irrigate_all", this.hass.language)}"
                  @click="${() => {
        this._confirmIrrigate = "all";
                ...
                >
                  <ha-icon icon="mdi:water"></ha-icon>
                  ${Ei("panels.zones.actions.irrigate_all", this.hass.language)}
                </button>
              ` : ""}
          ${i ? "" : F`<span class="zones-top-note"
                >${Ei("panels.info.cards.irrigate_now.no_linked_zones", this.hass.language)}</span
              >`}
        </div>
      </ha-card>
      ...
      ${null !== this._confirmIrrigate ? F`
        ...
        this._confirmIrrigate = null;
              ...
              heading="${Ei("panels.zones.confirm_irrigate.title", this.hass.language)}"
            >
              <p>
                ${Ei("panels.zones.confirm_irrigate.body", this.hass.language)}
              </p>
              <p>
                <strong>
                  ${"all" === this._confirmIrrigate ? `${Ei("panels.zones.confirm_irrigate.all_linked_zones", this.hass.language)} (${this._linkedZoneCount})` : null !== (t = null === (e = this.zones.find(e => {
        var t;
        ...
        this._confirmIrrigate = null;
                ...
                >
                  ${Ei("common.actions.cancel", this.hass.language)}
                </button>
                <button
      ...
      ${this._operationError ? F`
        ...
        this._operationError = null;
                  ...
                  aria-label="${Ei("common.actions.cancel", this.hass.language)}"
                ></ha-icon-button>
              </div>
            </ha-card>
          ` : ""}
  ...
  n([de()], Pi.prototype, "config", void 0), n([de({
    type: Boolean
  })], Pi.prototype, "hideSettingsLinks", void 0), n([de({
    attribute: !1
  })], Pi.prototype, "actionsMode", void 0), n([de({
    type: Array
  })], Pi.prototype, "zones", void 0), n([pe()], Pi.prototype, "_outlook", void 0), n([de({
    type: Boolean
  })], Pi.prototype, "isLoading", void 0), n([de({
    type: Boolean
  })], Pi.prototype, "isSaving", void 0), n([pe()], Pi.prototype, "_operationError", void 0), n([pe()], Pi.prototype, "_confirmIrrigate", void 0), n([pe()], Pi.prototype, "_skipDetailsOpen", void 0), customElements.get("smart-irrigation-view-zones") || customElements.define("smart-irrigation-view-zones", Pi);
  class Ni extends ce {
    setConfig(e) {
      this._config = e;
    }
    ...
    render() {
      ...
      if (!wi(this.hass.language)) return function (e) {
        const t = yi(e);
        return wi(e) ? Promise.resolve() : (_i[t] || (_i[t] = fetch(`/smart_irrigation_static/languages/${t}.json`).then(e => e.ok ? e.json() : Promise.reject(e.status)).then(e => {
          vi[t] = e;
        }).catch(() => {
          vi[t] = vi.en;
        })), _i[t]);
  ...
  n([de({
    attribute: !1
  })], Ni.prototype, "hass", void 0), n([pe()], Ni.prototype, "_config", void 0), customElements.get("smart-irrigation-zones-card") || customElements.define("smart-irrigation-zones-card", Ni);
  const Ii = window;
  Ii.customCards = Ii.customCards || [], Ii.customCards.some(e => "smart-irrigation-zones-card" === e.type) || (Ii.customCards.push({
    ...
    preview: !1
  }), console.info(`%c smart-irrigation-zones-card %c ${ve} `, "color: white; background: #3949ab; font-weight: 700;", "color: #3949ab; background: white; font-weight: 700;")), e.SmartIrrigationZonesCard = Ni, Object.defineProperty(e, "__esModule", {
    value: !0
  });
}({});
